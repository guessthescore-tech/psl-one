  ...
  return (
    ...
    >
      <Link
        ...
        aria-label={`${league.name} — Rank ${league.myRank} of ${league.memberCount.toLocaleString()}`}
      >
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 text-label-sm text-exp-muted">
              <span>{league.memberCount.toLocaleString()} members</span>
              <span>·</span>
              <span className="text-exp-gold font-black">
                Rank {league.myRank.toLocaleString()}/{league.memberCount.toLocaleString()}
              </span>
            </div>
          </div>
