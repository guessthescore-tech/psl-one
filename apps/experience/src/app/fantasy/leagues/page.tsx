...
const MOCK_PUBLIC_LEAGUES = [
  { id: 'pub-1', name: 'SA Fantasy Fans',      memberCount: 8420,  myRank: 0, myPoints: 0 },
  { id: 'pub-2', name: 'World Cup Watchers',   memberCount: 14350, myRank: 0, myPoints: 0 },
  { id: 'pub-3', name: 'African Football Fans', memberCount: 6102, myRank: 0, myPoints: 0 },
];
  ...
  return (
    <FantasyShell title="Fantasy Leagues" subtitle="Compete with friends and the world">
      <FantasyPageHero
        ...
        stats={[
          { label: 'My Leagues',   value: String(privateLeagues.length + publicLeagues.length) },
          { label: 'Global Rank',  value: `#${(88403).toLocaleString()}` },
            ...
            {MOCK_PUBLIC_LEAGUES.map((league, i) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-label-sm text-exp-muted">{league.memberCount.toLocaleString()} members</p>
                </div>
                <Link
            ...
            <div className="p-4">
              <div className="rounded-card bg-exp-navy border border-exp-gold/30 p-4 mb-4">
                ...
                <div className="text-label-sm text-exp-muted">
                  {globalLeague.memberCount.toLocaleString()} participants · Your rank:{' '}
                  <span className="text-exp-gold font-black">#{globalLeague.myRank.toLocaleString()}</span>
                </div>
              </div>
