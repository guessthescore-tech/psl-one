        ...
        <table className="w-full text-sm border-collapse border border-gray-200">
          <thead>
            <tr className="bg-gray-50">
              ...
              <th className="border border-gray-200 p-2 text-left">Deadline</th>
          ...
          <tbody>
            {data.fixtures.map((f) => (
              <tr key={f.id} className={f.isLocked ? 'bg-gray-50' : ''}>
                ...
                <td className="border border-gray-200 p-2 text-xs">{f.predictionDeadlineAt ? new Date(f.predictionDeadlineAt).toLocaleString() : '—'}</td>
