...
export default function PeerChallengesReadinessPage() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto space-y-6">
      ...
      <p className="text-sm text-gray-500">
        Peer challenges award Fan Value points only. No stakes, wagers, or real-money mechanics.
        Challenges are attached to published fixtures and settle automatically when the fixture settles.
      </p>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="p-4 bg-yellow-50 border border-yellow-200 rounded text-center">
          ...
          <div className="text-sm text-yellow-600">Pending (awaiting acceptance)</div>
        </div>
      ...
      {data.acceptedChallenges > 0 && (
        <div className="p-4 bg-orange-50 border border-orange-200 rounded text-sm text-orange-700">
          {data.acceptedChallenges} accepted challenge(s) are waiting for fixture settlement.
          These resolve automatically when the fixture is settled via Admin &rarr; Predictions &rarr; Settle Fixture.
        </div>
      )}

      <div className="p-3 bg-gray-50 border border-gray-200 rounded text-xs text-gray-500">
        PSL One — Fan points only. No real-money mechanics, no betting, no odds.
      </div>
    </div>
  );
}
