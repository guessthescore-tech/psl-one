...
describe('FantasyGameweekScoringService — calculatePlayerGameweekPoints', () => {
  ...
  beforeEach(() => {
    db = makeDb();
    svc = new FantasyGameweekScoringService(db, makeAutoSubMock(), makeFanValueMock(), makeAchievementsMock());
  });
...
describe('FantasyGameweekScoringService — settlement', () => {
  ...
  beforeEach(() => {
    ...
    svc = new FantasyGameweekScoringService(db, makeAutoSubMock(), fanValueMock, makeAchievementsMock());
  });
